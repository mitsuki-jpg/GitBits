...
self.appconfig = {
    ...
    self.addCollectionItem($(this).attr("data-id")), $(this).hasClass("btn-default") ? $(this).html('<i class="fas fa-check"></i>').toggleClass("btn-success btn-default") : $(this).hasClass("btn-success") ? $(this).html('<i class="far fa-bookmark"></i>').toggleClass("btn-default btn-success") : $(this).hasClass("badge-ext") && $(this).html('<i class="fa-duotone fa-circle-check"></i>')
