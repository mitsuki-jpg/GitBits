(function(b) {
  b.toast = function(c) {
    ...
    a = '<div id="' + h + '" class="toast" role="alert" aria-live="assertive" aria-atomic="true" ' + n + " " + l + ">" + ('<div class="toast-header"' + e + '">');
    ...
    a += '<span aria-hidden="true" class="' + g + '">&times;</span>';
    a += "</button>";
    a += "</div>";
    "" !== p && (a += '<div class="toast-body">',
      a += p, a += "</div>");
    a += "</div>";
    ...
    !1 !== l && (setTimeout(function() {
      m || b("#" + h).toast("hide")
    }, k), b(document).on("mouseover", "#" + h, function() {
      m = !0
    }), b(document).on("mouseleave", "#" + h, function() {
      var a = Math.floor(Date.now() / 1E3),
        c = parseInt(b(this).data("hide-timestamp"));
      m = !1;
      a >= c && b(this).toast("hide")
    }))
  }
})(jQuery);
